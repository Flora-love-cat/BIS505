...
setwd("/Users/wenxinxu/Desktop/BIS505/LABS")  # Modify path to your R Lab0 folder
...
##----------------------
# data file in my working directory
mydata <- read.table("data/hgb.csv", header=TRUE, sep=",") 
